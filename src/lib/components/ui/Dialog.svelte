	...
	>
		...
		<div class="flex gap-3">
			...
			<button
				type="button"
				onclick={onConfirm}
				class="flex-1 rounded-xl bg-linear-to-r from-cyan-500 to-purple-600 px-6 py-3 font-semibold text-white shadow-[0_0_20px_rgba(34,211,238,0.4)] transition-all hover:shadow-[0_0_30px_rgba(34,211,238,0.6)] active:scale-95"
			>
				{confirmText}
			</button>
		</div>
