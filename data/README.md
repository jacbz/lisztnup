...
2.  **Extract Raw Data (`musicbrainz.py`)**
    ...
    *   **Purpose:** Queries the database to generate `musicbrainz.json`. This is a large, unfiltered file containing a wide selection of classical composers and their works.
